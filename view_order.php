...
<head>
   ...
   <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.3/font/bootstrap-icons.css">
	...
	<title>The Moon Florist - Order Page</title>
</head>
<body>
	...
	<div class="banner">
        <div class="detail">
            <h1>my orders</h1>
            <p>Our skilled florists are crafting your order with <br>
			precision and care. Stay tuned for a breathtaking <br>
			arrangement that will surely leave a lasting impression.</p>
	...
	<div class="order-detail">
		<div class="heading">
			...
			<p>Thank you for choosing us to brighten your day.</p> 
