		...
		<section class="dashboard">
			...
			<div class="box-container">
				...
				<div class="box">
					...
					<a href="active_posts.php" class="btn">see products</a>
				</div>
				<div class="box">
					<?php 
				...
				<div class="box">
					...
					<a href="canceled_order.php" class="btn">canceled order</a>
				</div>
				<div class="box">
					<?php 
					...
					<a href="confirmed_order.php" class="btn">confirmed order</a>
				</div>
				<div class="box">
					<?php 
