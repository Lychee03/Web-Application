	...
	<div class="main-container">
		...
		<section class="show-post">
			...
			<div class="box-container">
				<?php 
					$select_post = $conn->prepare("SELECT * FROM `products` WHERE seller_id = ? AND status = 'active'");
				...
				<form action="" method="post" class="box">
					...
					<?php } ?>
					<div class="status" style="color: limegreen;"><?=$fetch_post['status']; ?></div>	
				...
				<?php 
						...
						echo '
							<div class="empty">
								<p>no active product added yet! <br><a href="add_product.php" class="btn" style="margin-top: 1.5rem;">add product</a></p>
							</div>
						';
					}
				?>
