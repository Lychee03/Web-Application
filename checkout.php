...
<head>
	...
	<title>The Moon Florist - Checkout Page</title>
</head>
<body>
	<?php include 'components/user_header.php'; ?>
		...
		<div class="banner">
	        <div class="detail">
	            <h1>checkout</h1>
	            <p>Final Touches <br>
                 Securely Checkout and Bring Your <br> Floral Vision to Life!</p>
			...
			<div class="heading">
                ...
                <div class="row">
                	...
                	<div class="summary">
                		...
                		<div class="grand-total"><span>total amount payable: </span>RM<?= $grand_total ?></div>
                	</div>
			</div>
		</section>
