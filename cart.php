...
<head>
   ...
   <link rel="stylesheet" href="css/user_style.css">
	<title>The Moon Florist - Cart Page</title>
</head>
<body>
	...
	<div class="banner">
        <div class="detail">
            <h1>cart</h1>
            <p>Your Blooms Await <br>
            Review and Finalize Your Floral Masterpieces!</p>
		...
		<div class="box-container">
			...
			<form action="" method="post" class="box <?php if($fetch_products['stock'] == 0){echo 'disabled';}; ?>">
				...
				<div class="content">
					...
					<div class="flex-btn">
						<p class="sub-total">sub total : <span>RM<?= $sub_total = ($fetch_cart['qty']*$fetch_cart['price']); ?></span></p>
